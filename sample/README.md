...
Or, you can also upload [google_colab/katawrap_sample_colab.ipynb](google_colab/katawrap_sample_colab.ipynb) to [Google Colaboratory](https://colab.research.google.com/) and run KataGo + katawrap there. (Do not forget to change runtime type to GPU.)
